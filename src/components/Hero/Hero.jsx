      ...
      <section className="container grid grid-cols-1 md:grid-cols-2 h-screen relative ">
        ...
        <div className="flex flex-col justify-center items-center py-14 md:py-0 ">
          <div className=" font-playfair text-center md:text-left ">
            <motion.h1 variants={SlideRight(.6)} 
            initial ="hidden"
            animate="visible"
        ...
        <motion.div variants={SlideRight(1.5)} 
            initial ="hidden"
            animate="visible" className="flex md:self-start justify-center gap-8 md:justify-start mt-4">
          <button className="primary-btn flex items-center gap-2  ">Order Now</button>
          <button className="flex justify-center items-center gap-2"><IoIosPlay />Watch Now</button>
        </motion.div>
        </div>
        
        <div className="flex items-center justify-center">
          <img src={dumbell} alt="" className="w-[350px] md:w-[550px] xl:w-[700px] drop-shadow"  />
        </div>
      </section>
    </>
  );
