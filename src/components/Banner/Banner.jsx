  ...
  <div className="container mb-5">
    <div className="bg-[#f6f6f6]  grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 py-14">
      ...
      className="flex justify-center">
        <img className="w-[300px] md:max-w-[400px] xl:min-w-[600px] h-full object-cover" src={img} alt="banner Image" />
      </motion.div>
      <div className="px-5 flex flex-col justify-center text-center lg:max-w-[500px] md:text-left space-y-4">
        ...
        initial = "hidden"
        whileInView= "visible"
         className="text-3xl lg:text-4xl mb-5 font-bold capitalize font-playfair  ">{title}</motion.h1>
        <motion.p 
        variants={SlideUp(.3)}
        initial = "hidden"
        whileInView= "visible"
