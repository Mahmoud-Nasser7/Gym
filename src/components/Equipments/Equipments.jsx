  ...
  return (
    <>
      <div className="container py-24">
        <div className="grid gird-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 font-playfair">
          ...
          </div>
          {
            EquipmentsData.map((item,index)=>(
              ...
              key={index} className=" space-y-4 p-6 bg-[#f6f6f6] rounded-xl hover:bg-white duration-500 hover:shadow-2xl ">
